...
> *WARNING! Railway does not support deployment of userbots and such on their free plan anymore. You can deploy USERGE on Railway but that'll definitely FREEZE YOUR ACCOUNT and then you can't deploy new projects or update existing projects without verifying your account by adding a payment method.*
